...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex fixed inset-y-0 left-0 w-64 flex-col bg-navy-900 text-white border-r border-white/5 z-30">
      <Link
        href="/"
        className="flex items-center gap-3 px-6 h-20 border-b border-white/5 shrink-0"
      >
        <span className="relative flex h-9 w-9 items-center justify-center rounded-full bg-gold-500/15 ring-1 ring-gold-500/40">
          <span className="h-3.5 w-3.5 rounded-full bg-gold-500" />
        </span>
        <span className="flex flex-col leading-tight">
          <span className="font-semibold tracking-wide text-white text-base">Capital Circle</span>
          <span className="text-[10px] uppercase tracking-[0.18em] text-gold-400">Private Marketplace</span>
        </span>
      </Link>
      ...
      <div className="px-5 py-5 border-t border-white/5">
        <div className="rounded-xl p-4 bg-gradient-to-br from-navy-800 to-navy-700 ring-1 ring-white/5">
          <div className="text-[11px] uppercase tracking-[0.16em] text-gold-400 mb-1.5">Membership</div>
