  ...
  return (
    <div className="rounded-2xl bg-navy-900 text-white ring-1 ring-white/5 overflow-hidden">
      ...
      <div className="p-5 md:p-6 pt-0 space-y-2.5">
        ...
        <button
          type="button"
          className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-white/5 hover:bg-white/10 ring-1 ring-white/15 text-white font-medium px-5 py-3 text-sm transition-colors"
        >
